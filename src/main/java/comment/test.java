...
public class test {
    public static void main(String[] args) {
        ...
        ApplicationContext c = new ClassPathXmlApplicationContext(
                "commentbeans.xml");
        ProbabilityCalculator probCalc = (ProbabilityCalculator) c
                .getBean("commentprobabilitycalculator");

        Comment comm = new Comment("fucking libtards");
        System.out.println(probCalc.isSpam(comm));
        Scanner s = new Scanner(System.in);
        BayesCommentProbabilityTrainer t = (BayesCommentProbabilityTrainer) c
                .getBean("commentprobabilitytrainer");
