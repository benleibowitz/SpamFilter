...
public interface SpamAlgorithm {
    ...
    /*
     * If a word's probability of being a spam word is more than
     * LEGITIMATE_WORD_THRESHOLD away from 0.5, (ie, how far it is from 50/50),
     * use the word in calculation. This helps us avoid words that are 50%/50%
     * spam/real, and Bayesian poisoning EXAMPLE: if
